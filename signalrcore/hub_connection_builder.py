...
class HubConnectionBuilder(object):
    ...
    def with_automatic_reconnect(self, data: dict):
        ...
        reconnect_max_interval = data.get("reconnect_max_interval", 120)
        ...
        elif reconnection_type == ReconnectionType.exponential:
            self.reconnection_handler = ExponentialReconnectionHandler(
                reconnect_interval, reconnect_max_interval, max_attempts
            )
        return self
